      ...
      <div className="flex justify-between h-16">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <button  onClick={() => {
            ...
            }} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium cursor-pointer">Sign Up</button>
            <button onClick={() => {
              window.open("/login", "_blank");
            }} className="bg-gray-100 hover:bg-gray-200 text-gray-800 px-6 py-2 rounded-lg font-medium cursor-pointer">Login</button>
          </div>
